Accompanying codes, pre-trained checkpoints, and datasets of each component of our Det-Recon-Reg framework will be uploaded after the acceptance of the paper.
